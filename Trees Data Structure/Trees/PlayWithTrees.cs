...
namespace TreeData
{
    public class PlayWithTrees
    {
        static void Main()
        {
            ...
            IEnumerable<int> orderedTreeByDFS = tree.OrderDFS();

            foreach (var item in orderedTreeByDFS)
            {
            ...
            binaryTree.EachInOrder(binaryTree, c => Console.Write(" " + c));
            Console.WriteLine();

            Console.Write("Binary tree nodes (post-order):");
            binaryTree.EachPostOrder(binaryTree, c => Console.Write(" " + c));
            Console.WriteLine();
        }
